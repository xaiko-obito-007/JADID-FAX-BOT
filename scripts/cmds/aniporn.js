module.exports = {
	config: {
		...
		countDown: 60,
		role: 2,
		shortDescription: "get aniporn video",
		longDescription: "it will send aniporn  video",
		category: "𝟭𝟴+",
		guide: "{p}{n}anipornvdo",
	},
	...
	onStart: async function ({ api, event, message }) {
		...
		if (senderID !== null) {
			message.reply({
				body: '𝗺𝗮𝗸𝗲 𝘀𝘂𝗿𝗲 𝘁𝗼 𝘄𝗮𝘁𝗰𝗵 𝗳𝘂𝗹𝗹 𝘃𝗶𝗱𝗲𝗼 🥵🥵',
